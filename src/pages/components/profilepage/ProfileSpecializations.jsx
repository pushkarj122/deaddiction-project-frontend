...
const ProfileSpecializations = () => {
  const specializations = [
    { icon: <FaWineGlassAlt />, title: "Alcohol Addiction", description: "Comprehensive recovery plans for overcoming alcohol dependency." },
    { icon: <FaPills />, title: "Drug Addiction", description: "Tailored treatments to help break free from drug addiction." },
    { icon: <FaBrain />, title: "Behavioural Addiction", description: "Support for overcoming addictive behaviors like gambling and gaming." },
    { icon: <FaHeart />, title: "Mental Health Treatment", description: "Holistic care for a wide range of mental health challenges." },
    { icon: <FaSmile />, title: "Anxiety", description: "Specialized therapies to reduce stress and manage anxiety effectively." },
    { icon: <FaSadTear />, title: "Depression", description: "Personalized care to combat depression and restore well-being." },
  ];
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {specializations.map((spec, index) => (
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-sky-700 mb-2">{spec.title}</h3>
