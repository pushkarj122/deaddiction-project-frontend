  ...
  const centers = [
    {
      ...
      description:
        "A drug and alcohol deaddiction and wellness center using a holistic approach to addiction treatment without the use of brute force or suppression.",
      location: "AECS Layout, Kundalahalli",
      city: "Bangalore",
      image:
        "https://www.addictionresource.net/wp-content/uploads/2022/08/Untitled-8-7-1024x575.jpg.webp",
    },
    {
      name: "ABCD Deaddiction And Wellness Center",
      description:
    ...
    },
    {
      ...
      city: "Bangalore",
      image:
        "https://www.re-thinkingthefuture.com/rtf-fresh-perspectives/a1907-10-things-to-remember-while-designing-rehabilitation-centres/attachment/a1907-10-things-to-remember-while-designing-rehabilitation-center-image-8/",
    },
  ];
        ...
        {centers.map((center, index) => (
          ...
          >
            ...
            <div className="p-4 flex flex-col justify-between md:w-2/3">
              ...
              <div>
                <h5 className="text-gray-500 font-medium text-sm md:text-base">
                  {center.location}
                </h5>
